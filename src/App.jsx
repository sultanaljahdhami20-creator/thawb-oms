...
export default function App(){
  ...
  const [newO,setNewO]=useState({customer:"",phone:"",jackets:"",total:"",paid:"",orderType:""});
          ...
          return <div>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:16,marginBottom:20}}>
              ...
              <div style={{background:bgC,border:"1px solid "+bc,borderRadius:12,padding:20}}>
                ...
                {[[t.jackets,o.jackets],[rtl?"نوع الطلب":"Order Type",o.orderType?(rtl?ORDER_TYPES_AR[ORDER_TYPES_EN.indexOf(o.orderType)]:o.orderType):(rtl?"غير محدد":"Not set")],[t.total,fmt(o.total)],[t.paid,fmt(o.paid)]].map(([k,v])=>(
                  <div key={k} style={{display:"flex",justifyContent:"space-between",padding:"5px 0"}}>
                    <span style={{fontSize:12,color:tm}}>{k}</span><span style={{fontSize:13,fontWeight:600}}>{v}</span>
                  </div>
                ))}
